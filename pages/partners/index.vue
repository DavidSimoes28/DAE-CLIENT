<template>
  <div>
    <b-container>
      ...
      <div>
        <button class="btn btn-outline-primary" v-on:click.prevent="filterPartners">Filter</button>
      ...
      <nuxt-link class="btn btn-secondary" to="/partners/create">Create a New Partners</nuxt-link>
