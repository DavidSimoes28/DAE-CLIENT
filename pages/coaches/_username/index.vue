<template>
  <div>
    <b-container>
      ...
      <nuxt-link class="btn btn-info" to="/coaches" v-show="this.auth">Back</nuxt-link>
      <nuxt-link class="btn btn-success" :to="`/coaches/${this.username}/email-send`">Send Email to Athletes</nuxt-link>
